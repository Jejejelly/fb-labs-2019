...
void copytext()
{
	...
	const int n = 34;
	int length; 
	char strLC[n] = { ' ', 'а', 'б', 'в', 'г', 'д', 'е', 'ё', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ъ', 'ы', 'ь', 'э', 'ю', 'я' };
	char strUC[n] = { ' ', 'А', 'Б', 'В', 'Г', 'Д', 'Е', 'Ё', 'Ж', 'З', 'И', 'Й', 'К', 'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф', 'Х', 'Ц', 'Ч', 'Ш', 'Щ', 'Ъ', 'Ы', 'Ь', 'Э', 'Ю', 'Я' };
...
void monog()
{
	...
	char strLC[n] = { ' ','а', 'б', 'в', 'г', 'д', 'е', 'ж', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о', 'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ы', 'ь', 'э', 'ю', 'я' };
...
void bigr_ws_wi() // Перетин з пробілами
{
	...
	string arr1[n * n];
	for (int i = 0; i < n * n; i++)
		arr1[i] == "  ";/////Типу весь масив забив нулями (подвійними пробілами)
	...
	output <<setw(9) << "Entropy = " << sum << endl;
...
void bigr_ws_ni() // Без перетину з пробілами
{
...
void bigr_ns_wi() // Перетин без пробілів
{
...
void bigr_ns_ni() // Без перетину без пробілів
{
